...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo json_encode($total_pendings);
      ?>
      ...
      <?php
         ...
         echo json_encode($total_completed);
      ?>
      ...
      <?php
         ...
         echo json_encode($number_of_orders);
      ?>
      ...
      <?php
         ...
         echo json_encode($number_of_products);
      ?>
      ...
      <?php
         ...
         echo json_encode($number_of_users);
      ?>
      ...
      <?php
         ...
         echo json_encode($number_of_admins);
      ?>
      ...
      <?php
         ...
         echo json_encode($number_of_accounts);
      ?>
      ...
      <?php
         ...
         echo json_encode($number_of_messages);
      ?>
